...
The text stimulus consisted of an excerpt from the opening of Ryunosuke Akutagawa's short story ``Hana'' (``The Nose''), distributed by Aozora Bunko \cite{akutagawa_aozora_hana}. The excerpt was selected as a single literary stimulus of moderate complexity and began with the description of Zenchi Naigu's nose. Source metadata are available from Aozora Bunko, including the base text, parent base text, and first publication in \textit{Shinshicho} in February 1916. Exact stimulus length, line breaks, font, and display layout should be documented before journal submission.
